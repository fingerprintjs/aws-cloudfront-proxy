...
describe('Download agent endpoint', () => {
  ...
  test('Call with no params', async () => {
    ...
    expect(url.toString()).toEqual(
      `https://${origin}/web/v3/ujKG34hUYKLJKJ1F?apiKey=ujKG34hUYKLJKJ1F&ii=fingerprintjs-pro-cloudfront%2F__lambda_func_version__%2Fingress`
    )
  })
  ...
  test('Call with version', async () => {
    ...
    expect(url.toString()).toEqual(
      `https://${origin}/web/v5/ujKG34hUYKLJKJ1F?apiKey=ujKG34hUYKLJKJ1F&version=5&ii=fingerprintjs-pro-cloudfront%2F__lambda_func_version__%2Fingress`
    )
  })
  ...
  test('Call with version and loaderVersion', async () => {
    ...
    expect(url.toString()).toEqual(
      `https://${origin}/web/v5/ujKG34hUYKLJKJ1F/loader_v3.6.5.js?apiKey=ujKG34hUYKLJKJ1F&version=5&loaderVersion=3.6.5&ii=fingerprintjs-pro-cloudfront%2F__lambda_func_version__%2Fingress`
    )
  })
  ...
  test('Call with a custom query', async () => {
    ...
    expect(url.toString()).toEqual(
      `https://${origin}/web/v5/ujKG34hUYKLJKJ1F/loader_v3.6.5.js?apiKey=ujKG34hUYKLJKJ1F&version=5&loaderVersion=3.6.5&someKey=someValue&ii=fingerprintjs-pro-cloudfront%2F__lambda_func_version__%2Fingress`
    )
  })
